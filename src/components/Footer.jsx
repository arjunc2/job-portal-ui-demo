          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 p-4 bg-gray-900 border border-gray-700 rounded-xl text-xs text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 text-left shadow-xl">
                  <p className="font-semibold text-white mb-2">Privacy Policy</p>
                  <p className="leading-relaxed">We are committed to protecting your personal information. We collect only what is necessary to provide our services, never sell your data to third parties, and give you control over your information. Your privacy is our priority.</p>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 p-4 bg-gray-900 border border-gray-700 rounded-xl text-xs text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 text-left shadow-xl">
                  ...
                  <p className="leading-relaxed">By using JobPortal, you agree to our terms governing your use of the platform, including job postings, applications, and account responsibilities. We reserve the right to update these terms. Continued use of the service constitutes acceptance of any changes.</p>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 p-4 bg-gray-900 border border-gray-700 rounded-xl text-xs text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 text-left shadow-xl">
                  ...
                  <p className="leading-relaxed">We use cookies to enhance your browsing experience, remember your preferences, keep you logged in, and analyze site traffic. Essential cookies are always active. By continuing to use JobPortal, you consent to our use of cookies in accordance with this policy.</p>
                </div>
              </a>
              <Link
                to="/contact"
              ...
              >
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 p-4 bg-gray-900 border border-gray-700 rounded-xl text-xs text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 text-left shadow-xl">
                  ...
                  <p className="leading-relaxed">Having an issue or need help? Reach out to our support team. You can send us a message and our admin team will get back to you as soon as possible to resolve any problems you&apos;re facing.</p>
                </div>
              </Link>
            </div>
